...
public class ApartamentoinquilinoApiController : BaseApiController {
[HttpPost]
 public IHttpActionResult Graba([FromBody] BeApartamentoInquilino c) {
...
[HttpPost]
public IHttpActionResult Del([FromBody] BeApartamentoInquilino c) {
BlApartamentoInquilino b = new BlApartamentoInquilino();
try {
b.Del(c);
...
[HttpPost]
public IHttpActionResult EditEst([FromBody] BeApartamentoInquilino c) {
BlApartamentoInquilino b = new BlApartamentoInquilino();
try {
b.EditEst(c);
