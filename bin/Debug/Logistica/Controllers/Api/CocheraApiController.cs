...
public class CocheraApiController : BaseApiController {
[HttpPost]
 public IHttpActionResult Graba([FromBody] BeCochera c) {
...
[HttpPost]
public IHttpActionResult Del([FromBody] BeCochera c) {
BlCochera b = new BlCochera();
try {
b.Del(c);
...
[HttpPost]
public IHttpActionResult EditEst([FromBody] BeCochera c) {
BlCochera b = new BlCochera();
try {
b.EditEst(c);
