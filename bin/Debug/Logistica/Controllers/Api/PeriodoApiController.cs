...
public class PeriodoApiController : BaseApiController {
[HttpPost]
 public IHttpActionResult Graba([FromBody] BePeriodo c) {
...
[HttpPost]
public IHttpActionResult Del([FromBody] BePeriodo c) {
BlPeriodo b = new BlPeriodo();
try {
b.Del(c);
...
[HttpPost]
public IHttpActionResult EditEst([FromBody] BePeriodo c) {
BlPeriodo b = new BlPeriodo();
try {
b.EditEst(c);
