...
public class ServiciocalculoApiController : BaseApiController {
[HttpPost]
 public IHttpActionResult Graba([FromBody] BeServicioCalculo c) {
BlServicioCalculo b = new BlServicioCalculo();
try {
if (ModeloValido) {
if (c.CoEstadoPagina == Enu.CoEstadoPagina.Nuevo) {
c.CoServicioCalculo = b.Add(c);
...
[HttpPost]
public IHttpActionResult Del([FromBody] BeServicioCalculo c) {
BlServicioCalculo b = new BlServicioCalculo();
try {
b.Del(c);
...
[HttpPost]
public IHttpActionResult EditEst([FromBody] BeServicioCalculo c) {
BlServicioCalculo b = new BlServicioCalculo();
try {
b.EditEst(c);
